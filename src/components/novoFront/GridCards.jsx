...
<NavLink to="render"><Button variant='primary' size='lg' style={{marginBottom:"1rem"}}>Começar!</Button></NavLink><Progress type="circle" strokeColor={twoColors}  percent={arredondar(progress,0)} size={80} style={{marginRight:"1rem"}} className={`${styles.progress}`} /></div>
