...
export const StepListProvider = ({ children }) => {
    const temas = [
    { id: 1, title: "Segmentação de Mercado", color: "primary", tema: "Mercado", desc: "Identifique uma lista de mercados em que sua ideia é possível", description:"Vamos iniciar nossa jornada de refinamento da ideia do empreendedor, no Passo 1, iremos pensar todas as possibilidades de aplicação da nossa ideia, pensando em diferentes possíveis usuários finais para que possamos definir uma tática de pesquisa.", objective:"Criar uma lista de possíveis mercados candidatos e uma metodologia para investigar eles", instructions:"Utilize a resposta do gerador para fazer sua própria lista. Adicione mercados que você já sabe que faz sentido à lista gerada.Retire aqueles que você já antevê que não faz sentido. Faça a pesquisa primária, converse com gente de verdade.", exercise:"Indique os 5 principais mercados que você acredita que faz sentido para sua ideia" },
    { id: 2, title: "Mercado Inicial", color: "primary", tema: "Mercado", desc: "Defina qual que vai ser seu mercado inicial estratégico para dar partida a sua jornada", description:"Agora iremos focar nossas energias em apenas um local para que possamos ser mais estratégicos.Então, a partir da lista de mercados definida anteriormente, iremos avaliar qual o que mais faz sentido com relação a sua ideia.", objective:"Investigar a lista de mercados candidatos e definir qual o melhor mercado para iniciarmos", instructions:"A partir da lista de mercados entregada no passo anterior, entenda o argumento da minha resposta e pondere se você concorda ou não.Faça suas adaptações no detalhamento do mercado.", exercise:"Indique qual o seu Mercado Inicial de forma detalhada"  },
    { id: 3, title: "Perfil do Usuário Final", color: "secondary", tema: "Cliente", desc: "Entenda quem será seu usuário mais a fundo e encontre suas características" ,description:"Hora de usar o resultado da sua Pesquisa Primária de mercado.Me conta os principais achados da sua pesquisa de mercado, quem é seu cliente? Quais as principais características dele?", objective:"Achar características marcantes, relevantes e comuns entre seus possíveis usuários", instructions:"Utilize sua pesquisa primária e a esquematize em uma tabela. Me conte quais são as principais características, eu te darei algumas dicas de possíveis características para você investigar, e também vou te ajudar como investigar Pesquise com gente de verdade.", exercise:"Indique os principais achados do perfil do seu usuário." },
